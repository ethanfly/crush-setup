(function (root) {
  ...
  var en = {
    ...
    "err.json": "Must be valid JSON.",
    "form.section.identity": "Identity",
    "form.section.connection": "Connection",
    "form.section.flags": "Flags",
    "form.section.advanced": "Advanced",
    "form.section.command": "Process",
    "form.section.http": "HTTP",
    "form.section.auth": "Auth",
    "form.section.tools": "Tools",
    "form.section.behavior": "Behavior",
    "form.section.paths": "Paths",
    "form.section.attribution": "Attribution",
    "form.section.lsp": "Attach",
    ...
    "think.title": "Thinking & limits",
    "think.cardSub": "Reasoning, context window, and max tokens for the large and small slots.",
    "field.think": "Think",
    "field.reasoningEffort": "Reasoning effort",
    "field.defaultReasoningEffort": "Default reasoning effort",
    "effort.off": "Off",
    "effort.low": "Low",
    "effort.medium": "Medium",
    "effort.high": "High",
    "btn.maxThink": "Max intensity",
    "status.maxThink": "Thinking set to maximum intensity.",
    "status.maxThinkNone": "Pick a large or small model first.",
    "field.slotMaxTokens": "Max tokens",
    "btn.maxLimits": "Max context / tokens",
    "status.maxLimits": "Context and max tokens set to this model's full window.",
    "err.positiveInt": "Enter a number greater than zero.",
    ...
    "hint.think": "Enable thinking / reasoning for this slot (--think).",
    "hint.reasoning_effort": "Reasoning effort Crush sends for this slot (low / medium / high).",
    "hint.default_reasoning_effort": "Default effort when a slot does not override it.",
    "hint.slot_think": "Thinking level for the selected model.",
    "hint.maxThink": "Turn on thinking and set reasoning effort to high for both slots.",
    "hint.maxLimits": "Set max tokens (and the model default) to this model's context window.",
    "hint.maxModelLimits": "Fill max tokens from the context window (or 128000 if empty).",
  ...
  var zh = {
    ...
    "err.json": "必须是合法 JSON。",
    "form.section.identity": "身份",
    "form.section.connection": "连接",
    "form.section.flags": "开关",
    "form.section.advanced": "高级",
    "form.section.command": "进程",
    "form.section.http": "HTTP",
    "form.section.auth": "认证",
    "form.section.tools": "工具",
    "form.section.behavior": "行为",
    "form.section.paths": "路径",
    "form.section.attribution": "署名",
    "form.section.lsp": "附着",
    ...
    "slot.small": "小模型",
    "think.title": "思考与上下文",
    "think.cardSub": "大模型 / 小模型槽位的推理强度、上下文窗口和最大 token。",
    "field.think": "思考",
    "field.reasoningEffort": "思考等级",
    "field.defaultReasoningEffort": "默认思考等级",
    "effort.off": "关闭",
    "effort.low": "低",
    "effort.medium": "中",
    "effort.high": "高",
    "btn.maxThink": "一键最大强度",
    "status.maxThink": "已将思考等级设为最大强度。",
    "status.maxThinkNone": "请先选择大模型或小模型。",
    "field.slotMaxTokens": "最大 token",
    "btn.maxLimits": "一键最大上下文",
    "status.maxLimits": "已将最大 token 设为该模型的完整上下文窗口。",
    "err.positiveInt": "请输入大于 0 的数字。",
    "badge.disabled": "已禁用",
    "badge.allow": "允许",
    "badge.deny": "拒绝",
    "badge.env": "环境变量",
    ...
    "hint.think": "为该槽位开启思考 / 推理（--think）。",
    "hint.reasoning_effort": "该槽位发给 Crush 的推理强度（low / medium / high）。",
    "hint.default_reasoning_effort": "槽位未覆盖时，该模型使用的默认推理强度。",
    "hint.slot_think": "当前所选模型的思考等级。",
    "hint.maxThink": "同时为大模型和小模型开启思考，并把等级设为最高。",
    "hint.maxLimits": "把最大输出 token（以及模型默认值）设为该模型的上下文窗口。",
    "hint.maxModelLimits": "用上下文窗口填入最大 token；窗口为空时用 128000。",
